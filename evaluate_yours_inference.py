#!/usr/bin/env python3
"""
Evaluate your inference on dense dataset for comparison with Senthil's fast inference
"""
...
def main():
    ...
    results_dir = data_dir / "results_yours_inference"
    ...
    print("=" * 80)
    print("EVALUATING YOUR INFERENCE ON DENSE DATASET")
    print("=" * 80)
