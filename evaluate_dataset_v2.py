#!/usr/bin/env python3
"""
Evaluate your inference on dataset_v2_two_noise_100_14-8-26
Dataset structure: dataset_v2_two_noise_100_14-8-26/pair_XXX/ with reference.png, search.png, target.png
Ground truth format: Uses "center_x"/"center_y" (standard format)
"""
...
def main():
    ...
    results_dir = Path(data_dir) / "results_yours_inference"
    ...
    print("=" * 80)
    print("EVALUATING YOUR INFERENCE ON DATASET_V2_TWO_NOISE_100")
    print("=" * 80)
